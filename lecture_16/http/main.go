...
// upor mukhu
// body te msg kono change korle abar server.exe -build korte hobe
//{go build -0 server.exe (like this) }
//listen,accept,read,write only this 4 func
